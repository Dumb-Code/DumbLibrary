...
import net.dumbcode.dumblibrary.server.animation.AnimationEntry;
...
public class S0SyncAnimation implements IMessage {
    ...
    public <E extends Entity> S0SyncAnimation(int operation, E entity, AnimationEntry entry, int channel) {
