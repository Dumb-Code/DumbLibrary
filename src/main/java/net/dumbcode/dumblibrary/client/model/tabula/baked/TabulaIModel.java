...
public class TabulaIModel implements IModel {
     ...
     * For example;
     * <ul>
     * <li>{@link EnumFacing#UP} {@code -> 0b010 -> 2}</li>
     * <li>{@link EnumFacing#DOWN} {@code -> 0b000 -> 0}</li>
     * <li>{@link EnumFacing#EAST} {@code -> 0b100 -> 4}</li>
     * <li>{@link EnumFacing#NORTH} {@code -> 0b000 -> 0}</li>
     * </ul>
