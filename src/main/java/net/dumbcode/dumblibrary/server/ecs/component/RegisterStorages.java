...
public class RegisterStorages {

    public static <T extends EntityComponent, S extends EntityComponentStorage<T>> EntityComponentType.StorageOverride<T, S> register(EntityComponentType<T, ?> type, String overrideName, Supplier<S> constructor) {
